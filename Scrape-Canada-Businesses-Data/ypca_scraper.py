...
class Scraper():
    ...
    def locs(self):
        ...
        self.thread(requests.get, self.prov_urls())
    ...
    def subbus_cats(self, prov_index=0, loc_index=0):
      ...
      self.thread(requests.get, self.bus_cat_urls(prov_index, loc_index))
    ...
    def subsubbus_cats(self, prov_index=0, loc_index=0):
        ...
        self.thread(requests.get, self.subbus_cat_urls(prov_index, loc_index))
    ...
    def bus_names(self, prov_index=0, loc_index=0):
        ...
        self.thread(requests.get, self.subsubbus_cat_urls(prov_index, loc_index))
